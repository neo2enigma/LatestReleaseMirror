...
| File | Size | Download |
|------|------|----------|
| `slipnet-linux-amd64` | 2.8 MB | [⬇️ Download](https://raw.githubusercontent.com/neo2enigma/LatestReleaseMirror/main/releases/anonvector/SlipNet/slipnet-linux-amd64) |
<!-- RELEASES_END -->
